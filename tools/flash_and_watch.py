...
print("Example: python3 esp_bt_audio_source/tools/run_unity.py --project-root esp_bt_audio_source/test/test_app --port /dev/ttyUSB0 --timeout 600", file=sys.stderr)
sys.exit(2)
