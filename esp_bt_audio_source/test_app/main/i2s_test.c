#include <stdio.h>
#include <string.h>
#include <inttypes.h> // Add this for PRIu32 macros
...
/**
 * @brief Test I2S driver initialization with standard mode
 */
...
/**
 * @brief Test I2S standard mode configuration for audio input
 */
static void test_i2s_std_config(void)
{
    ...
    // Fix format specifiers for uint32_t
    ...
    // Configure I2S standard mode - updated for ESP-IDF v5.4.1
...
/**
 * @brief Run all I2S tests for audio input configuration
 */
