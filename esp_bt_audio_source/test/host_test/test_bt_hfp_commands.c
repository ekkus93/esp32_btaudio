...
int main(void)
{
    ...
    RUN_TEST(test_hfp_stats_reports_fd13_available_diagnostics);
    RUN_TEST(test_hfp_stats_reports_unavailable_diagnostics_without_fake_zero);
    RUN_TEST(test_hfp_stats_diagnostic_failure_is_exact_and_not_partial);
